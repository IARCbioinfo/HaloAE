# Inspired from : https://github.com/YoungGod/DFR/blob/master/DFR-source/vgg.py
...
model_dirs = {
    ...
    'vgg19': '/home/mathiane/LNENWork/MvTech/VGG19/vgg19-dcbb9e9d.pth',#'/home/jovyan/work/model-checkpoints/vgg19-dcbb9e9d.pth',
}
...
def make_layers(cfg, batch_norm=False):
    ...
    for v in cfg:
        if v == 'M':
            ...
            in_channels = v
    print('EnD make layer features map')
